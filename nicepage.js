!(function (t) {
  ...
  357: function (t, e, i) {
    ...
    n.registerAnimation(i(358)),
      n.registerAnimation(i(361)),
      n.registerAnimation(i(151));
  },
  358: function (t, e, i) {
    "use strict";
    function n(t, e) {
              ...
              if (e)
                if (!ce && !le && !Pt) {
                  var n = e,
                    o;
                  if (Li)
                    if ((clearTimeout(Li), (Li = null), Re(n, Di)))
      ...
      !(function (e, i, n) {
        ...
        (o.prototype.refresh = function (t) {
          var e,
            ...
            a = false;
          if (t === n)
            (a = true), (Bt = []), (Kt = 0), (t = i.getElementsByTagName("*"));
          ...
          for (e = 0, o = t.length; e < o; e++) {
            ...
            if (el.attributes) {
              ...
              if (u.length) {
                var _, A, id;
                if (!a && P in el)
                  (id = el[P]), (_ = Bt[id].styleAttr), (A = Bt[id].classAttr);
            ...
            for (h = 0, p = Bt.length; h < p; h++)
              for (
                ...
                if ("relative" === c.mode)
                  pt(n),
                    (c.frame =
                      Dt.relativeToAbsolute(o, c.anchors[0], c.anchors[1]) - m),
                    pt(n, true);
                if (((c.frame += v), Rt))
  ...
  8984: function (t, e, i) {
    ...
    n(function () {
      ...
      (FormRating.subscribe = function t() {
        ...
        i.mouseleave(FormRating.onLeave),
          FormRating.onLeave({ currentTarget: i });
      });
  },
  8985: function (t, e) {},
});
